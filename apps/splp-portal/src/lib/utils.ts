...
export const MOCK_APIS = [
  ...
  { id: 'api-002', icon: '📋', name: 'Data Kependudukan', agency: 'Dukcapil', version: 'v2.0', category: 'Kependudukan', calls: 23100, latency: 210, status: 'active', sla: 99.5, auth: 'OAuth2/JWT', method: 'GET', endpoint: `${_gw}/dukcapil/v2/data/data-kependudukan`, rateLimit: '500 req/min', description: 'Mengambil data kependudukan lengkap berdasarkan NIK dari basis data Dukcapil.', sampleRequest: { nik: '3201234567890001', fields: ['nama', 'alamat', 'status'] } },
